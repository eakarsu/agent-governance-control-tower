# Agent Governance Control Tower App

Industry: **Legal, Compliance & Risk**  
Specialization: **Agent Governance Control Tower**

This standalone application consolidates source-backed capabilities into 8 optimized features, including 7 visible data-backed or AI-enabled views. Its public demo SQLite database contains 0 sanitized source rows across 0 imported tables and 120 operational workflow records.
...
- `ai-agent-governance-control-tower`
- `ai-board-governance-briefing-assistant`
- `ai-product-compliance-evidence-vault`
